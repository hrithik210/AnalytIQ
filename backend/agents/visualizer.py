...
class Visualizer:
	...
	async def create_visualization(self, cleaned_csv_path: str ,analyst_output, retrieved_context: Optional[Dict[str, List[str]]] = None):
			# Read the CSV file
			...
			if retrieved_context:
				rag_snippets.extend(retrieved_context.get("analyst", []))
